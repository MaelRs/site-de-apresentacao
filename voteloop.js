...
let totalVotes = 0; // Número total de votos a serem processados
...
function castVote(event) {
  ...
  if (voteCount === totalVotes) { // Verifica se atingiu o número total de votos
    disableVoting();
  }
}
...
function startVoting(numVotes) {
  totalVotes = numVotes;
}

// Exemplo de uso: startVoting(10);
